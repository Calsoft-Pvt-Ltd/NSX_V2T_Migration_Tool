        ...
        try:
            ...
            for edgeClusterName in edgeClusterNameList:
                ...
                if not edgeClusterData:
                    raise Exception("Failed to get edgeCluster data : {}".format(edgeClusterName))
                url = "{}{}{}".format(
                    nsxtConstants.NSXT_HOST_POLICY_API.format(self.ipAddress),
                ...
                if response.status_code == requests.codes.ok:
                    ...
                    raise Exception('Failed to get edgeCluster {}, details due to error {}'.format(edgeClusterName, response.content))
        ...
        try:
            ...
            for edgeClusterName in edgeClusterNameList:
                ...
                if response.status_code == requests.codes.ok:
                    ...
                    raise Exception('Failed to get edgeCluster {}, details due to error {}'.format(edgeClusterName,
                                                                                                   response.content))
            edgeNodePortgroupList = zip(edgeClusterMembers, portgroupList)
        ...
        try:
                ...
                if orgVdcNetwork['networkType'] != 'DIRECT' and orgVdcNetwork['networkType'] != 'OPAQUE':
                    ...
                    if switchTags:
                        switchList.append((networkData['display_name'], networkData['id'],
                                           networkData['transport_zone_path'], networkData['path']))
            ...
            for edgeClusterName in edgeClusterNameList:
                ...
                if edgeClusterData:
                    ...
                    raise Exception('Failed to get edgeCluster {}, details.'.format(edgeClusterName))
