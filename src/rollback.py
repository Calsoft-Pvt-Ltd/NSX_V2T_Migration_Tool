...
class Rollback:
    ...
    def _createRollbackKeyValues(self):
        ...
        self.rollbackTask.append('vcdObj.resetTargetExternalNetwork(self.vcdDict.NSXVProviderVDCExternalNetwork)')
    ...
    def perform(self, vcdObj, vcdValidationObj, nsxtObj, rollbackTasks=None):
        ...
        try:
            ...
            if targetOrgVDCId:
                ...
                targetNetworkList = vcdObj.retrieveNetworkListFromMetadata(targetOrgVDCId, orgVDCType='target')
        except:
            pass
